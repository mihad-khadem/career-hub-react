...
const JobDetails = () => {
    ...
    console.log(job);
    const {logo, job_title, company_name, remote_or_onsite, location, job_type, salary,job_description, contact_information, educational_requirements, experiences, job_responsibility
        ...
        <div className=" my-20">
            ...
            <div className="grid gap-4 md:grid-cols-4">
                <div className="border md:col-span-3 p-5 rounded-md shadow-md">
                    <p className="my-6"><strong>Job Description :</strong>{job_description}</p>
                    <p className="my-6"><strong>Educational Requirement : </strong>{educational_requirements}</p>
                    <p className="my-6"><strong>Job Responsibility : </strong>{job_responsibility}</p>
                    <p className="my-6"><strong>Experiences : </strong>{experiences}</p>
                </div>
                <div className="border bg-[#9873FF1A] p-2 rounded-md shadow-md">
                    ...
                    <button className="btn w-full bg-[#7E90FE] text-white mt-4">Apply Now</button>
